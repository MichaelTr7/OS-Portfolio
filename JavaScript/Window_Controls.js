...
function Minimize_Window(){
  ...
  Root.style.setProperty('--X_Position_1',X_Position_1);
  Root.style.setProperty('--Y_Position_1',Y_Position_1);
  Root.style.setProperty('--X_Position_2',X_Position_2);
  Root.style.setProperty('--Y_Position_2',Y_Position_2);
  Parent_Window.dataset.origin_x1 = String(X_Position_1);
  Parent_Window.dataset.origin_x2 = String(X_Position_2);
  Parent_Window.dataset.origin_y1 = String(Y_Position_1);
  Parent_Window.dataset.origin_y2 = String(Y_Position_2);
...
function Toggle_Window(){
  ...
  Root.style.setProperty('--X_Position_2R',String(Target_Window.dataset.origin_x2));
  Root.style.setProperty('--Y_Position_2R',String(Target_Window.dataset.origin_y2));
